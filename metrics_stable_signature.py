...
def main(params):
    ...
    if params.eval_imgs:
        ...
        log_path = os.path.join(params.output_dir + params.output_data_name, 'img_metrics.csv')
        os.makedirs(os.path.dirname(log_path), exist_ok=True)
        img_df.to_csv(log_path, index=False)
    ...
    if params.eval_bits:
        ...
        log_path = os.path.join(params.output_dir  + params.output_data_name, 'log_stats.csv')
        os.makedirs(os.path.dirname(log_path), exist_ok=True)
...
def get_parser():
    ...
    aa("--msg_decoder_path", type=str, default= "decoder/dec_48b_whit.torchscript.pt")
